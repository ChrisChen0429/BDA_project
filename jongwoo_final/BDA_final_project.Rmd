...
baseline_model_binom = stan_model('./binomial_stan/binomial_baseline_city.stan')
fit1 <- sampling(baseline_model_binom, data=baseline_data)
...
2. Poisson
```{r results='hide', warning=FALSE, message=FALSE}
baseline_model_pois = stan_model('./poisson_baseline_city.stan')
fit2 <- sampling(baseline_model_pois, data=baseline_data, seed=1234)
print(fit2, pars=c('a', 'beta', 'lp__'))
```
