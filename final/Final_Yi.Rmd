...
And it shows that the cross validation for model 2 is : ** **. 
...
model2_data = list(S=S,N_train=N_train, N_test=N_test, D=D,state_train = state_train,state_test = state_test,
