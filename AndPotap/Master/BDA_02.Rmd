...
```{r Run first STAN model, message=FALSE, warning=FALSEf}
...
```{r Run second STAN model, message=FALSE, warning=FALSE}
...
```{r Run third STAN model, message=FALSE, warning=FALSE}
