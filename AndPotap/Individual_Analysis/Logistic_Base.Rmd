...
file <-  '../DBs/core.txt'
file_model_logistic <- './Models/logistic_base_v01.stan'
```
...
data_stan_train = list(N=N, S=S, state=state, y=y_train)
```
...
proba_hat = invlogit(alpha_s_median[ID_state_test])
